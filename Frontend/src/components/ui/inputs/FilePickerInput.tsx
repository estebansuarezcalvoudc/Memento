...
export default function FilePickerInput({
  ...
  return (
    <div
      className={`font-ubuntu flex h-8 w-full items-center gap-2 rounded-lg border border-stone-300 bg-transparent px-2 text-base text-stone-800 focus-within:border-stone-500 dark:border-stone-600 dark:text-stone-100 dark:focus-within:border-stone-400 ${className}`}
    >
      <input
        id={inputId}
        type="file"
      ...
      <label
        htmlFor={inputId}
        className={`inline-flex h-6 shrink-0 items-center justify-center rounded-md border px-2 text-sm transition-colors ${
          disabled
      ...
      <span
        ...
        className="min-w-0 flex-1 truncate text-center text-base text-stone-500 dark:text-stone-400"
      >
