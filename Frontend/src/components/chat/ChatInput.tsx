...
export default function ChatInput({
  ...
  return (
    <div className="font-ubuntu mx-auto mb-2 flex w-full max-w-3xl items-center rounded-2xl border-2 border-stone-200 bg-stone-100 py-1 pr-1.5 pl-3 text-base dark:border-stone-600 dark:bg-stone-700">
      <textarea
        ref={textareaRef}
        rows={1}
        disabled={disabled}
